...
export default function RandomInspectionVerificationModal({ isOpen, onYes, onNo }) {
  return (
    <Modal isOpen={isOpen}>
      <div className="text-center">
        <h2 className="text-2xl font-bold mb-6 text-gray-800">
          Ist mit dem Einkauf alles korrekt?
        </h2>
...
RandomInspectionVerificationModal.propTypes = {
